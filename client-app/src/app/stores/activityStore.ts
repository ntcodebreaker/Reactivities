...
export default class ActivityStore {
  ...
  constructor() {
    ...
    // whenever the keys of the predicate change
    // reload the activities with new paging parameters
    reaction(
      () => this.predicate.keys(),
      () => {
  ...
  // choose another predefined filter + date
  ...
  // computed axios params based on paging parameters and predicates
  get axiosParams() {
